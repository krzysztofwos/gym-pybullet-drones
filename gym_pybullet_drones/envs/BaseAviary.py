...
class BaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(str(_resources.files('gym_pybullet_drones').joinpath('assets/'+self.URDF)),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(str(_resources.files('gym_pybullet_drones').joinpath('assets/'+self.URDF))).getroot()
